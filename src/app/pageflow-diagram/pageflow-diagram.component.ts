...
export class PageflowDiagramComponent implements OnInit {
  ...
  constructor(private pageflowServiceService: PageflowServiceService, private activatedRoute : ActivatedRoute) { }
  ...
  save() {
    ...
    //this.pageflowServiceService.getSampleData().subscribe(data => this.sampleData = data);
    this.utilityMethod();
  }
  ...
  public utilityMethod(): void{
        ...
        $(go.TextBlock, "",
          ...
          $(go.Panel, "Vertical",
            ...
            $(go.Panel, "Table",
              ...
              $(go.TextBlock, "Source", textStyle(),  // the name
                {
              ...
              $(go.TextBlock, textStyle(),
                { row: 1, column: 0, editable: false, isMultiline: false}),
              ...
              $(go.TextBlock, textStyle(),
                ...
                new go.Binding("text", "columns", function(v){ return v}).makeTwoWay()
                ),
              $(go.TextBlock, textStyle(),
                { row: 2, column: 0 },
              ...
              $(go.TextBlock, "Vacate Position"),
              {
                click: function(e, obj:any) {
                  ...
                  if (node !== null) {
                    ...
                    this.myDiagram.model.setDataProperty(thisemp, "TableName", "");
                    this.myDiagram.model.setDataProperty(thisemp, "Columns", "");
                    this.myDiagram.model.setDataProperty(thisemp, "alias", "");
    ...
    palette.model.nodeDataArray = [
      { key: 1, text: "Source", color: "green", isGroup: true },
      ...
      //{ category: "UndesiredEvent", reasonsList: [{}],inputData: {} },
      //{ category: "Comment" }
    ];
